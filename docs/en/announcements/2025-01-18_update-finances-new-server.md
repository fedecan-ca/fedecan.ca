...
summary: "Hello everyone, we're long overdue for an update on how things have been going! Finances: Since we started accepting donations back in July we've received a total of $1350, as well as $1707 in older donations from smorks. We haven't had any expenses other than OVH (approx $155/mo) since then, leaving us $2152 in the bank. "
...
<VpvImage
  :imageConfig="{
    image: 'https://lemmy.ca/pictrs/image/82e0e38e-2315-47f5-8a6e-fa50da706674.png',
    image_dark: 'https://lemmy.ca/pictrs/image/8f072e20-969e-4edb-b56d-ad6d4955a87f.png',
    alt: 'Server Migration Diagram',
    description: 'Server Migration Diagram',
    description_dark: 'Server Migration Diagram',
  }"
/>
...
<VpvEmbedLemmy
  headerTitle="You can also view this post on Lemmy"
  :links="[
