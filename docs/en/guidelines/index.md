...
::: tip You can jump to each section with the following links.

**Tier 1:** Fedecan Rules

- [Internal Conduct](1-internal-conduct.md)
- [Universal Rules](1-universal-rules.md)

**Tier 2:** Platform-specific Rules

- [lemmy.ca](2-lemmy-ca.md)
- [piefed.ca](2-piefed-ca.md)
- [pixelfed.ca](2-pixelfed-ca.md)
- [sh.itjust.works](2-sh-itjust-works.md)

**Tier 3:** Template Rules for Communities

- [Post Title Standards](3-post-title-standards.md)
...
::: info **To propose a change or start a discussion**, you can post to one of the following communities:

- All Platforms & Organizational Guidelines: [!fedecan@lemmy.ca](https://lemmy.ca/c/fedecan@lemmy.ca)
- Guidelines for **lemmy.ca**: [!main@lemmy.ca](https://lemmy.ca/c/main)
- Guidelines for **piefed.ca**: [!main@piefed.ca](https://piefed.ca/c/main)
- Guidelines for **pixelfed.ca**: [!pixelfed@lemmy.ca](https://lemmy.ca/c/pixelfed)
- Guidelines for **sh.itjust.works**: [!agora@sh.itjust.works](https://sh.itjust.works/c/agora)
...
- **Minor corrections**, such as typos, clarifications, and broken links, can happen at any time and will be recorded in the [changelog](/en/guidelines/changelog.md).
...
All changes are tracked in the [changelog](/en/guidelines/changelog.md).
