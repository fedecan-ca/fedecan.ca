...
In addition to the [Tier 1: Universal Rules](1-universal-rules.md), lemmy.ca has the following rules and policies.

::: info Proposed Rule Changes
To propose a change to these guidelines or start a discussion about how they are applied, you can post in one of the following communities: [!fedecan@lemmy.ca](https://lemmy.ca/c/fedecan@lemmy.ca), [!main@lemmy.ca](https://lemmy.ca/c/main).
:::
...
Please see this guide page: [How to block a user, community, or instance](https://fedecan.ca/en/guide/threadiverse/how-to-block)
...
Please see this guide page for more information: [How to deal with inappropriate content](https://fedecan.ca/en/guide/threadiverse/how-to-deal-with-inappropriate-content)
...
You cannot create communities for adult content on `lemmy.ca`. While you can engage with such content from remote instances, all content must be labelled as per [Tier 1 Rule 10](1-universal-rules.md#rule-10-sensitive-content-labelling) (Sensitive Content Labelling).

While you can use the [spoiler tags](https://fedecan.ca/en/guide/threadiverse/formatting-posts#spoilers) to hide embedded content in text posts, we recommend that you use an external link and mark the content as "`NSFW`" as some third-party apps do not support the spoiler syntax.
...
Automated accounts must comply with [Tier 1 Rule 11](1-universal-rules.md#rule-11-ai-generated-and-automated-content). The account must be labelled as a bot using the [account settings](https://lemmy.ca/settings), and it should have contact information so that users can reach out to the bot's operator with concerns. As per [Rule 3](#rule-3-vote-and-engagement-manipulation), you cannot vote using automated means.

### Rule 7: AI-Generated Content

::: warning This section is a placeholder.
...
1. If reports or messages go unanswered for 3 or more days, a user can reach out to the admins by messaging [@admin@lemmy.ca](https://lemmy.ca/u/admin).
...
Users can raise concerns about problematic moderation in essential communities, and admins will make an effort to mediate an acceptable solution. If you have concerns about moderation in an essential community, please post in [!fedecan@lemmy.ca](https://lemmy.ca/c/fedecan@lemmy.ca) or [!main@lemmy.ca](https://lemmy.ca/c/main).
...
- Propose changes to our federation policy by posting in the [!fedecan@lemmy.ca](https://lemmy.ca/c/fedecan@lemmy.ca) or [!main@lemmy.ca](https://lemmy.ca/c/main) communities.

- View a live list of federated and blocked instances: [lemmy.ca/instances](https://lemmy.ca/instances)

- View announcements about federation decisions: [!main@lemmy.ca](https://lemmy.ca/c/main)
