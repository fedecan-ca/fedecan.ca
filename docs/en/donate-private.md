...
::: tip This is the privacy-friendly version of the donation page

It does not include any third-party embeds or header code, and only contains links to donation methods instead of embedded buttons and forms. You can visit the regular donation page here: [donate](donate.md)
